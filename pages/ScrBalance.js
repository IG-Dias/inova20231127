...
export default function ScrBalance({navigation}) {
  ...
  return (
    <View style={{backgroundColor: '#FFFFFF', flex: 1, width: '100%', height: '100%'}}>
      ...
      <View style={{alignItems: 'center', paddingTop: 15, height: '99%'}}>
        <View style={{backgroundColor: '#F5F5F5', borderRadius: 10, width: "90%", height: '80%'}}>
          <View>
